...
if(isset($_POST['email'])) {
    ...
    $email_to = "jolisa.chan.store@gmail.com";
    ...
    function died($error) {
		...
		echo "Please email directly to jolisa.chan.store@gmail.com if error can't be fixed.";
        die();
    }
...
Thank you for contacting me. I will be in contact soon. Jolisa.
