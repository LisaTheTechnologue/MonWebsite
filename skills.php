	...
	<div class="container">
		<div class="row text-center" id="iconRow">
			<div class="col-md-4 sm-dev-padding">
				...
				<div class="progress-wrap">
					<h3>
					<span class="name-left">	JAVASCRIPT / JQUERY </span>
				...
				<div class="progress-wrap">
					<h3>						
						<span class="name-left">BOOTSTRAP 4 </span>		
			...
			<div class="col-md-4 sm-dev-padding">
				...
				<div class="progress-wrap">
					<h3>
						<span class="name-left">	JAVA</span>	
						<span class="value-right">		60%	</span>
					</h3>
					<div class="progress" style="height:5px" >
						<div class="progress-bar bg-warning progress-bar-striped progress-bar-animated" role="progressbar"
			...
			<div class="col-md-4 sm-dev-padding">
				...
				<h2>INTERESTS</h2>
					<ul>
						...
						<li>Making videos: Proshow Producer 7.0</li>
